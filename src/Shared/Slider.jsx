        ...
        <div>
            <div className="carousel w-full">
                ...
                <div id="slide2" className="carousel-item relative w-full h-72 md:h-[550px]">
                    <img src="https://i.ibb.co/hWRSw6d/banner2.jpg" className="w-full object-cover md:object-fill" />
                    <div className="absolute top-0 left-0 w-full h-full bg-black opacity-50" />
                    <div className="absolute text-white top-1/4 md:top-1/3 left-[10%] md:left-[15%]">
